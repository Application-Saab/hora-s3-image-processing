    ...
    try {
      ...
      if (isImage) {
        ...
        try {
          ...
          const uploadedCount = await WebLink.countDocuments({
            orderId: orderId.toString(),
            mainFolderId,
            status: "done",
            type: "image"
          ...
          if (uploadedCount > 0 && uploadedCount % 20 === 0) {
            console.log(`🚀 FACE API TRIGGER AT ${uploadedCount} IMAGES`);
